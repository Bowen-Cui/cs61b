...
public class LinkedListDeque<T> implements Deque<T>, Iterable<T> {
    ...
    *//**Returns true if deque is empty, false otherwise.*//*
    ...
    private T getRecursiveHelp(int index, Node n){
        if (index  ==0) {
            return n.item;
        }
     ...
     * o is considered equal if it is a Deque and if it
     * contains the same contents (as goverened by the generic T’s equals method)
     * in the same order.
